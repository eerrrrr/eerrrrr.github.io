# CLAUDE.md — Erin Wong Portfolio (eerrrrr.github.io)
...
Pushing to `main` publishes via GitHub Pages. There is no CI, no
preview environment, no staging. Once pushed, it's live within ~30s.

Remote: `https://github.com/eerrrrr/eerrrrr.github.io.git`.
...
This repo (`eerrrrr.github.io`) is the **BACKUP**.
The **PRIMARY** is `E:\my-portfolio-website\eerrrrr.portfolio.github.io`.
